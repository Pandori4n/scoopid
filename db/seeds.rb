...
attendancy1 = SearchPartyAttendancy.create!(itinerary: coordinates_three, color: "#FFF", start_date_time: DateTime.new(2020,12,1,14), end_date_time: DateTime.new(2020,12,1,18), user: volunteer1, search_party: search)
