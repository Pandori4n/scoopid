...
# message2 = Message.create!(content: "T'inquiète pas, on va le retrouver !", chatroom: chatroom1, user: chatroom1.volunteer)
message1 = Message.create!(content: "Tourne à gauche et demande dans la boulangerie", chatroom: chatroom1, user: host)
message2 = Message.create!(content: "Bien joué ! Ils l'ont vu passer il y a 5min !", chatroom: chatroom1, user: chatroom1.volunteer)
message2 = Message.create!(content: "J'ai trouvé Marcel !", chatroom: chatroom1, user: volunteer1)
